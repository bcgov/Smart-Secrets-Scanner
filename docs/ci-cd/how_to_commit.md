...
This guide walks you through committing changes to the Smart-Secrets-Scanner project, including pre-commit hook validation and conventional commit format.
