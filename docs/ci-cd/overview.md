...
This document outlines the Continuous Integration (CI) pipeline and the standard development workflow for projects built with the **Smart-Secrets-Scanner** protocol. It details the lifecycle of a code change from a developer's workstation to the main branch on GitHub.
...
- **[GitHub Repository Setup Guide](./git_setup.md)** - Configure GitHub Actions, security scanning, and branch protection
...
2.  **Development & Verification**
    ...
    *   **Verification:**
    *   Run linting and tests as appropriate for your project.
...
- **XSS vulnerabilities:** Sanitize output properly
...
Severity: High
File: scripts/some_script.py:45
...
- Store secrets in environment variables (see [WSL Secrets Configuration](../WSL_SECRETS_CONFIGURATION.md))
- Enable push protection in GitHub settings

**Example secret scanning alert:**
```
Alert: Hugging Face Token detected
File: .env
Commit: abc123def456
Status: Active
...
4. **Reach out** to the team lead or security contact
